...
src_dir = "/pine/scr/p/l/pllittle/CS_eQTL/s3_Real/scRNAseq_pipelines/dronc"
data_dir = src_dir
dronc_dir = file.path(src_dir,"GTEx_droncseq_hip_pcf")
```
...
counts_mx = as.matrix(counts[,-1])
rownames(counts_mx) = counts$V1
sce = SingleCellExperiment(assays = list(counts = counts_mx))
sce
```
