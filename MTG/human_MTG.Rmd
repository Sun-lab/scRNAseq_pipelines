...
Import gene infomration and add them into the ```sce``` object. We also check for spike ins. Those gene names starting with ERCC are indeed gene names rather than labels for spke-ins. 
