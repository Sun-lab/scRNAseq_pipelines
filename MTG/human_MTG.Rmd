...
Next we add the sample/cell information and gene information. Spike-ins are used for this data, though in this final count matrix, the spike-ins are not included. 
...
```{r gene_selection, fig.dim = c(8,8), fig.path='figures/', dev=c('png')}
...
```{r tsne, fig.dim = c(8,8), fig.path='figures/', dev=c('png')}
...
```{r kmeans, fig.dim = c(8,8), fig.path='figures/', dev=c('png')}
...
```{r sc3, fig.dim = c(8,8), eval = run_sc3, echo = run_sc3,fig.path='figures/', dev=c('png')}
