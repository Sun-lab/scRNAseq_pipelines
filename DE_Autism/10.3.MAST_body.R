...
for(ncell in ncell_seq){
  for(n in n_seq){
    ...
    for(i_s in c(selected_index,max_n+selected_index)){
      cell_index=(max_ncell*i_s-ncell+1):(max_ncell*i_s)
    ...
    for(perm_label in perm_label_seq){
      ...
      print(date())
      print(gc())
      tryCatch(saveRDS(MAST_pval0,paste0("../Data_PRJNA434002/10.Result/",sim_folder,"/MAST_pval/p",perm_label,perm_method,"_MAST_pval0_",noise_flag,r_mean,"_",r_var,"_",r_change_prop,"_",dp_minor_prop,"_",file_tag,"_",(2*n),"_",ncell,".rds")), error = function(e) {NA} )
      tryCatch(saveRDS(MAST_pval1,paste0("../Data_PRJNA434002/10.Result/",sim_folder,"/MAST_pval/p",perm_label,perm_method,"_MAST_pval1_",noise_flag,r_mean,"_",r_var,"_",r_change_prop,"_",dp_minor_prop,"_",file_tag,"_",(2*n),"_",ncell,".rds")), error = function(e) {NA} )
      print(c(n,ncell))
    }
  }
}
