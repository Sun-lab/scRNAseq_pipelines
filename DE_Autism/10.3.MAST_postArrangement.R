  ...
  for(r_var in r_var_seq){
    for(sim_method in sim_method_seq){
      for(file_tag in file_tag_seq){
        ...
        saveRDS(MAST_pval,paste0("../Data_PRJNA434002/10.Result/MAST_pval_",sim_method,"_",r_mean,"_",r_var,"_",file_tag,".rds"))
        saveRDS(MAST_pval_ob,paste0("../Data_PRJNA434002/10.Result/MAST_pval_ob_",sim_method,"_",r_mean,"_",r_var,"_",file_tag,".rds"))
        saveRDS(MAST_pval_perm,paste0("../Data_PRJNA434002/10.Result/MAST_pval_perm_",sim_method,"_",r_mean,"_",r_var,"_",file_tag,".rds"))
  ...
  for(r_var in r_var_seq){
    for(sim_method in sim_method_seq){
      for(file_tag in file_tag_seq){
        for(i in 0:perm_num){
          if(file.exists(paste0("../Data_PRJNA434002/10.Result/MAST_org_pval_",sim_method,"_",r_mean,"_",r_var,"_",file_tag,"_",i,".rds"))){
            file.remove(paste0("../Data_PRJNA434002/10.Result/MAST_org_pval_",sim_method,"_",r_mean,"_",r_var,"_",file_tag,"_",i,".rds"))
          }
        }
      }
    }
