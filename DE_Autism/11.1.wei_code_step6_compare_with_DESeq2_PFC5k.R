...
meta = read.table("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/github/ideas/Autism/R/res/step4_meta_PFC3k.tsv",header = TRUE, sep = "\t")
dim(meta)
meta[1:2,]

meta_ind = read.table("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/github/ideas/Autism/R/res/step4_meta_ind_PFC3k.tsv",header = TRUE, sep = "\t")
dim(meta_ind)
meta_ind[1:2,]
...
dat1 = readRDS("/fh/fast/sun_w/mengqi/Data_PRJNA434002/rawMPFC3k_L23.rds")
class(dat1)
...
zinb_fit_dca = readRDS("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/github/ideas/Autism/R/res/step4a_zinb_fit_dca_PFC3k.rds")
...
deseq2_input1 = write.table(paste0("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/github/ideas/Autism/R/res/step1_DESeq2_PFC3k_no_covariates_PFC3k.txt"))
deseq2_input2 = write.table(paste0("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/github/ideas/Autism/R/res/step1_DESeq2_PFC3k_adj_covariates_PFC3k.txt"))

deseq2_no_cov = read.table(file=deseq2_input1, sep="\t", header=TRUE)
dim(deseq2_no_cov)
deseq2_no_cov[1:2,]

deseq2 = read.table(file=deseq2_input2, sep="\t", header=TRUE)
dim(deseq2)
deseq2[1:2,]

df = read.table("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/github/ideas/Autism/R/res/step5a_pvals_PFC3k.tsv",header = TRUE, sep = "\t")
dim(df)
df[1:2,]
...
pdf(file="/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step6_DESeq2_vs_IDEAS_PFC3k.pdf", width=13.5, height=9)
...
pdf("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step6_DESeq2_rd_only_pval_grp_by_DESeq2_and_ideas_pval_PFC3k.pdf", 
    width=5, height=3)
...
plot.deseq2.vs.ideas(meta_ind, gnm, gdata, gene_i_fit, dist1, max.x=10, 
                     fnm = "/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step6_ex_DESeq2+_ideas-CNOT2-DT_PFC3k.pdf")
...
plot.deseq2.vs.ideas(meta_ind, gnm, gdata, gene_i_fit, dist1, max.x=7, 
                     fnm = "/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step6_ex_DESeq2-_ideas+_MICU2_PFC3k.pdf")
...
plot.deseq2.vs.ideas(meta_ind, gnm, gdata, gene_i_fit, dist1, max.x=7, 
                     fnm = "/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step6_ex_DESeq2-_ideas+_MBP_PFC3k.pdf")
...
plot.deseq2.vs.ideas(meta_ind, gnm, gdata, gene_i_fit, dist1, max.x=4, 
                     fnm = "/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step6_ex_DESeq2-_ideas+_SLC38A10_PFC3k.pdf")
...
plot.deseq2.vs.ideas(meta_ind, gnm, gdata, gene_i_fit, dist1, max.x=7, 
                     fnm = "/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step6_ex_DESeq2-_ideas+_GNG7_PFC3k.pdf")
...
plot.deseq2.vs.ideas(meta_ind, gnm, gdata, gene_i_fit, dist1, max.x=5, 
                     fnm = "/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step6_ex_DESeq2+_ideas+_CDK11B_PFC3k.pdf")
...
plot.deseq2.vs.ideas(meta_ind, gnm, gdata, gene_i_fit, dist1, max.x=5, 
                     fnm = "/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step6_ex_DESeq2+_ideas+_TCF25_PFC3k.pdf")
...
plot.deseq2.vs.ideas(meta_ind, gnm, gdata, gene_i_fit, dist1, max.x=5, 
                     fnm = "/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step6_ex_DESeq2+_ideas+_PNCK_PFC3k.pdf")
