---
title:  "A workflow for Defferential expression data analysis-Autism, Part I"
...
dim(gene.annotation)
gene.annotation[1:2,]
head(table(gene.annotation$chromosome_name))
head(table(gene.annotation$gene_biotype))
