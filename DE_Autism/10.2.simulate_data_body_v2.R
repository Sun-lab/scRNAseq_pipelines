...
input_file_tag="3k"
t_mean = read.table(paste0("../Data_PRJNA434002/res_dca_rawM",input_file_tag,"/mean.tsv"), 
                    sep = "\t", header = TRUE)

t_disp = read.table(paste0("../Data_PRJNA434002/res_dca_rawM",input_file_tag,"/dispersion.tsv"),
                    sep = "\t", header = TRUE)

t_drop = read.table(paste0("../Data_PRJNA434002/res_dca_rawM",input_file_tag,"/dropout.tsv"),
                    sep = "\t", header = TRUE)
...
#here we generate a matrix for calculate the mean of 2 individuals values.
sample_log_mean_array=array(dim=dim(sample_log_mean)[c(1,2,2)])
sample_disp_array=array(dim=dim(sample_disp)[c(1,2,2)])
sample_drop_array=array(dim=dim(sample_drop)[c(1,2,2)])
sample_log_mean_sd_array=array(dim=dim(sample_log_mean_sd)[c(1,2,2)])

for(i_ind in 1:ncol(sample_log_mean)){
  for(j_ind in 1:ncol(sample_log_mean)){
    sample_log_mean_array[,i_ind,j_ind]=(sample_log_mean[,i_ind]+sample_log_mean[,j_ind])/2
    sample_disp_array[,i_ind,j_ind]=(sample_disp[,i_ind]+sample_disp[,j_ind])/2
    sample_drop_array[,i_ind,j_ind]=(sample_drop[,i_ind]+sample_drop[,j_ind])/2
    sample_log_mean_sd_array[,i_ind,j_ind]=(sample_log_mean_sd[,i_ind]+sample_log_mean_sd[,j_ind])/2
  }
}

sample_log_mean=t(apply(sample_log_mean_array,1,c))
sample_disp=t(apply(sample_disp_array,1,c))
sample_drop=t(apply(sample_drop_array,1,c))
sample_log_mean_sd=t(apply(sample_log_mean_sd_array,1,c))
...
# scatter plot 
pdf(paste0("../Data_PRJNA434002/10.Result/sim_v2/check_simulation/check_simulation_scatter_",r_mean,"_",r_var,"_",r_disp,"_",r_change_prop,"_",file_tag,".pdf"), 
    width = 9, height = 6)
...
pdf(paste0("../Data_PRJNA434002/10.Result/sim_v2/check_covariates/check_covariates_",r_mean,"_",r_var,"_",r_disp,"_",r_change_prop,"_",file_tag,".pdf"), 
    width=6, height=3)
...
saveRDS(de.mean,paste0("../Data_PRJNA434002/10.Result/sim_v2/de_label/sim_de.mean_",r_mean,"_",r_var,"_",r_disp,"_",r_change_prop,"_",file_tag,".rds"))
saveRDS(de.var,paste0("../Data_PRJNA434002/10.Result/sim_v2/de_label/sim_de.var_",r_mean,"_",r_var,"_",r_disp,"_",r_change_prop,"_",file_tag,".rds"))
saveRDS(de.disp,paste0("../Data_PRJNA434002/10.Result/sim_v2/de_label/sim_de.disp_",r_mean,"_",r_var,"_",r_disp,"_",r_change_prop,"_",file_tag,".rds"))
saveRDS(de.mult,paste0("../Data_PRJNA434002/10.Result/sim_v2/de_label/sim_de.mult_",r_mean,"_",r_var,"_",r_disp,"_",r_change_prop,"_",file_tag,".rds"))

saveRDS(read_depth,paste0("../Data_PRJNA434002/10.Result/sim_v2/sim_ind/sim_ind_readdepth_",r_mean,"_",r_var,"_",r_disp,"_",r_change_prop,"_",file_tag,".rds"))
saveRDS(phenotype_ind,paste0("../Data_PRJNA434002/10.Result/sim_v2/sim_ind/sim_ind_phenotye_",r_mean,"_",r_var,"_",r_disp,"_",r_change_prop,"_",file_tag,".rds"))
saveRDS(zero_rate_ind,paste0("../Data_PRJNA434002/10.Result/sim_v2/sim_ind/sim_ind_zero_rate_",r_mean,"_",r_var,"_",r_disp,"_",r_change_prop,"_",file_tag,".rds"))

saveRDS(sim_param,paste0("../Data_PRJNA434002/10.Result/sim_v2/sim_data/sim_param_",r_mean,"_",r_var,"_",r_disp,"_",r_change_prop,"_",file_tag,".rds"))
saveRDS(sim_matrix,paste0("../Data_PRJNA434002/10.Result/sim_v2/sim_data/sim_matrix_",r_mean,"_",r_var,"_",r_disp,"_",r_change_prop,"_",file_tag,".rds"))
saveRDS(meta,paste0("../Data_PRJNA434002/10.Result/sim_v2/sim_data/sim_meta_",r_mean,"_",r_var,"_",r_disp,"_",r_change_prop,"_",file_tag,".rds"))
saveRDS(sim_matrix_bulk,paste0("../Data_PRJNA434002/10.Result/sim_v2/sim_data/sim_matrix_bulk_",r_mean,"_",r_var,"_",r_disp,"_",r_change_prop,"_",file_tag,".rds"))
