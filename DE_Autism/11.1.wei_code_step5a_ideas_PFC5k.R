...
#a=sapply(zinb_fit_data,function(x)sapply(x,unlist))
...
saveRDS(dist_array,"/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step4a_zinb_fit_dca_dist_array_PFC3k.rds")
# ------------------------------------------------------------------------
...
pdf("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step5a_pval_hist_confounders2_PFC3k.pdf", width=6, height=6)
...
pdf("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step5a_pval_hist2_PFC3k.pdf", width=6, height=6)
...
fwrite(df, file="/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/github/ideas/Autism/R/res/step5a_pvals2_PFC3k.tsv", sep="\t")
...
pdf("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step5a_pval_hist_permuted_x2_PFC3k.pdf", width=6, height=6)
ggarrange(gh0.n, gh1.n, gh2.n, gh3.n, ncol = 2, nrow = 2)
dev.off()

pdf("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step5a_pval_hist_permuted_x_details2_PFC3k.pdf", width=12, height=9)
par(mfrow=c(3,4))
