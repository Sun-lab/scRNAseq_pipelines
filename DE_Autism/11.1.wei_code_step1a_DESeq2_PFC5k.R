...
pdf("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step1_DESeq2_L23_compare_pval_PFC3k.df", width=9, height=3)
...
pdf(paste0("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step1_DESeq2_L23_pval_hist_PFC3k.pdf"), width=9, height=9)
...
# w2kp = which(q75 >= 20)
# 
# pdf(paste0("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step1_DESeq2_L23_pval_hist_q75_ge20_PFC3k.pdf"), 
#     width=9, height=9)
# par(mfrow=c(3,3), bty="n", mar=c(5,4,2,1))
# for(k in 1:length(nms)){
...
pdf("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step1_DESeq2_L23_pval_hist_final_PFC3k.pdf",width=9, height=6)
...
write.table(res0, "/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/github/ideas/Autism/R/res/step1_DESeq2_L23_no_covariates_PFC3k.txt", quote = FALSE, sep = "\t", row.names = TRUE, col.names = TRUE)

write.table(res, "/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/github/ideas/Autism/R/res/step1_DESeq2_L23_adj_covariates_PFC3k.txt", quote = FALSE, sep = "\t", row.names = TRUE, col.names = TRUE)

write.table(trec1,"/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/github/ideas/Autism/R/res/step1_DESeq2_L23_edata_PFC3k.txt",quote = FALSE, sep = "\t", row.names = TRUE, col.names = TRUE)

write.table(meta, "/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/github/ideas/Autism/R/res/step1_DESeq2_L23_meta_cell_PFC3k.txt", sep="\t")
write.table(meta_ind, "/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/github/ideas/Autism/R/res/step1_DESeq2_L23_meta_ind_PFC3k.txt", sep="\t")
...
pdf(paste0("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step1_DESeq2_L23_pval_hist_final_permuted_PFC3k.pdf"), 
    width=9, height=9)
par(mfrow=c(3,3), bty="n", mar=c(5,4,2,1))
for(k in 1:nrep){
...
pdf(paste0("/fh/fast/sun_w/mengqi/1.Testing_scRNAseq/Command/11.1.wei_code_check/step1_DESeq2_L23_resid_PCs_vs_permuted_case_control_PFC3k.pdf"), 
    width=9, height=9)
