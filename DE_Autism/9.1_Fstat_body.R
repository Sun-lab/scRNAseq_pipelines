...
fit_tag_seq=c("","nb","raw")

#ind_covariate_flag_seq="ind" #c("","ind") 
  ...
  for(resid_flag in resid_flag_seq){
    for(covariate_flag in covariate_flag_seq){
      for(fit_tag in fit_tag_seq){
        if(file.exists(paste0("../",dataset_folder,"/8.Result/",dist_method,"_",fit_method,"_array_",resid_flag,covariate_flag,fit_tag,pre_tag,"_sim_",cluster_tag,"_",file_tag,".rds"))){
          dist_array=NA
          dist_pval=NA
          
          dist_array=readRDS(paste0("../",dataset_folder,"/8.Result/",dist_method,"_",fit_method,"_array_",resid_flag,covariate_flag,fit_tag,pre_tag,"_sim_",cluster_tag,"_",file_tag,".rds"))
          ...
          for(perm_label in perm_label_seq){
            ...
            #plot 
            png(paste0("../",dataset_folder,"/8.Result/fig_Fstat/p",perm_label,perm_method,"_",dist_method,"_",fit_method,"_",F_method,"_pval_",resid_flag,covariate_flag,fit_tag,pre_tag,"_sim_",cluster_tag,"_",file_tag,".png"),height = 900,width = 1800,type="cairo")
            op=par(mfrow = c(2, 4))
            ...
            png(paste0("../",dataset_folder,"/8.Result/fig_Fstat/p",perm_label,perm_method,"_",dist_method,"_",fit_method,"_",F_method,"_pval_",resid_flag,covariate_flag,fit_tag,pre_tag,"_sim_",cluster_tag,"_",file_tag,"_Fob.png"),height = 600,width = 1200,type="cairo")
            ...
            #   saveRDS(dist_pval,paste0("../",dataset_folder,"/8.Result/"dist_method,"_",fit_method,"_pval/p",perm_label,perm_method,"_",dist_method,"_",fit_method,"_",F_method,"_pval_",ind_covariate_flag,resid_flag,covariate_flag,fit_tag,pre_tag,"_sim_",cluster_tag,"_",file_tag,".rds"))
          ...
          saveRDS(pval_ob,paste0("../",dataset_folder,"/8.Result/",dist_method,"_",fit_method,"_pval/p",perm_label,perm_method,"_",dist_method,"_",fit_method,"_",F_method,"_pval_",ind_covariate_flag,resid_flag,covariate_flag,fit_tag,pre_tag,"_sim_",cluster_tag,"_",file_tag,".rds"))
          saveRDS(pval_perm,paste0("../",dataset_folder,"/8.Result/",dist_method,"_",fit_method,"_pval/p",perm_label,perm_method,"_",dist_method,"_",fit_method,"_",F_method,"_perm_pval_",ind_covariate_flag,resid_flag,covariate_flag,fit_tag,pre_tag,"_sim_",cluster_tag,"_",file_tag,".rds"))
          
          saveRDS(anova_centroid_pval_ob,paste0("../",dataset_folder,"/8.Result/",dist_method,"_",fit_method,"_pval/p",perm_label,perm_method,"_",dist_method,"_",fit_method,"_",F_method,"_anova_centroid_pval_",ind_covariate_flag,resid_flag,covariate_flag,fit_tag,pre_tag,"_sim_",cluster_tag,"_",file_tag,".rds"))
          saveRDS(anova_centroid_pval_perm,paste0("../",dataset_folder,"/8.Result/",dist_method,"_",fit_method,"_pval/p",perm_label,perm_method,"_",dist_method,"_",fit_method,"_",F_method,"_perm_anova_centroid_pval_",ind_covariate_flag,resid_flag,covariate_flag,resid_flag,covariate_flag,fit_tag,pre_tag,"_sim_",cluster_tag,"_",file_tag,".rds"))
          
          gc()
          print(c(ind_covariate_flag,resid_flag,covariate_flag,fit_tag))
        }
      }
    }
  }
