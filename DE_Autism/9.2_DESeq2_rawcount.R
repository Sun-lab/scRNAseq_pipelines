...
saveRDS(cell_num,paste0("../Data_PRJNA434002/7.Result/rawcount_ind_cellnum_",cluster_tag,"_",file_tag,".rds"))
saveRDS(read_depth,paste0("../Data_PRJNA434002/7.Result/rawcount_ind_readdepth_",cluster_tag,"_",file_tag,".rds"))
saveRDS(zero_rate_ind,paste0("../Data_PRJNA434002/7.Result/rawcount_ind_zero_rate_",cluster_tag,"_",file_tag,".rds"))
saveRDS(rawcount_matrix_bulk,paste0("../Data_PRJNA434002/7.Result/rawcount_matrix_bulk_",cluster_tag,"_",file_tag,".rds"))
...
saveRDS(zero_rate,paste0("../Data_PRJNA434002/7.Result/rawcount_gene_zero_rate_",cluster_tag,"_",file_tag,".rds"))
saveRDS(read_count_total,paste0("../Data_PRJNA434002/7.Result/rawcount_gene_read_count_total_",cluster_tag,"_",file_tag,".rds"))
...
saveRDS(de_ob_pval,paste0("../Data_PRJNA434002/8.Result/DESeq2_pval/p",perm_label,"_DESeq2_ob_pval_",cluster_tag,"_",file_tag,".rds"))
