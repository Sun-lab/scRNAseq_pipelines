...
deconvolution_dir = "~/scRNAseq_pipelines/MTG"
...
# run ICeDT
icedt_file = file.path(deconvolution_dir,"CMC_ICeDT_fitw0_genes_from_psychENCODE.rds")
if (!file.exists()) {
  ...
  fitw0 = ICeDT::ICeDT(Y=bulk_subset, Z=tpm_signature_genes, 
                       ...
                       rhoConverge = 1e-2)
  date()
  saveRDS(fitw0, file = icedt_file)
}
fitw0 = readRDS(icedt_file)
